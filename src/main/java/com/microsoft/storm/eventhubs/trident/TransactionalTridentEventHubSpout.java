...
import com.microsoft.eventhubs.spout.IEventDataScheme;

import backtype.storm.task.TopologyContext;
import backtype.storm.tuple.Fields;
import storm.trident.spout.IPartitionedTridentSpout;
import com.microsoft.eventhubs.trident.Partition;
...
public class TransactionalTridentEventHubSpout implements 
  ...
  public IPartitionedTridentSpout.Coordinator<Partitions> getCoordinator(
    ...
    return new com.microsoft.eventhubs.trident.Coordinator(spoutConfig);
  }
